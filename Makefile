...
# Generated by qmake (2.01a) (Qt 4.8.7) on: mar. avr. 10 16:46:09 2018
# Project:  main.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/projet1.0.0/ && $(COPY_FILE) --parents shader.h trackball.h camera.h viewer.h grid.h .tmp/projet1.0.0/ && $(COPY_FILE) --parents shader.cpp trackball.cpp camera.cpp main.cpp viewer.cpp grid.cpp .tmp/projet1.0.0/ && (cd `dirname .tmp/projet1.0.0` && $(TAR) projet1.0.0.tar projet1.0.0 && $(COMPRESS) projet1.0.0.tar) && $(MOVE) `dirname .tmp/projet1.0.0`/projet1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/projet1.0.0
